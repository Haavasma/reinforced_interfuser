...
export CHECKPOINT_ENDPOINT=data_gen/results/weather-9/results/routes_training_town01.json
export SAVE_PATH=expert_data
export TEAM_CONFIG=yamls/weather-9.yaml
export TRAFFIC_SEED=20018
export CARLA_SEED=20018
export SCENARIOS=routes/all_towns_traffic_scenarios.json
export ROUTES=routes/routes_training_town01.xml
export TM_PORT=20518
export PORT=20018
