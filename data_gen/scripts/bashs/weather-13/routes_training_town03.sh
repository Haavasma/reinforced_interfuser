...
export CHECKPOINT_ENDPOINT=data_gen/results/weather-13/results/routes_training_town03.json
export SAVE_PATH=expert_data
export TEAM_CONFIG=yamls/weather-13.yaml
export TRAFFIC_SEED=20026
export CARLA_SEED=20026
export SCENARIOS=routes/all_towns_traffic_scenarios.json
export ROUTES=routes/routes_training_town03.xml
export TM_PORT=20526
export PORT=20026
