...
export CHECKPOINT_ENDPOINT=data_gen/results/weather-5/results/routes_training_town01.json
export SAVE_PATH=expert_data
export TEAM_CONFIG=yamls/weather-5.yaml
export TRAFFIC_SEED=20010
export CARLA_SEED=20010
export SCENARIOS=routes/all_towns_traffic_scenarios.json
export ROUTES=routes/routes_training_town01.xml
export TM_PORT=20510
export PORT=20010
