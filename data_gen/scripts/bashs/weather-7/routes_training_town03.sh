...
export CHECKPOINT_ENDPOINT=data_gen/results/weather-7/results/routes_training_town03.json
export SAVE_PATH=expert_data
export TEAM_CONFIG=yamls/weather-7.yaml
export TRAFFIC_SEED=20014
export CARLA_SEED=20014
export SCENARIOS=routes/all_towns_traffic_scenarios.json
export ROUTES=routes/routes_training_town03.xml
export TM_PORT=20514
export PORT=20014
