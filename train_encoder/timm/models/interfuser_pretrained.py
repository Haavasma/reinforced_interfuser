...
from .resnet import resnet26d, resnet50d, resnet18d, resnet101d
...
class InterfuserPretrained(nn.Module):
    def __init__(
        self,
        img_size=224,
...
@register_model
def interfuser_pretrained(**kwargs):
    model = InterfuserPretrained(
        enc_depth=6,
        dec_depth=6,
        embed_dim=256,
