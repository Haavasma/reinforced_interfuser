...
./distributed_train.sh $GPU_NUM $DATASET_ROOT  --dataset carla \
    --model interfuser_baseline --sched cosine --epochs 25 --warmup-epochs 5 --lr 0.0005 --batch-size 32  -j 10 --no-prefetcher --eval-metric l1_error \
